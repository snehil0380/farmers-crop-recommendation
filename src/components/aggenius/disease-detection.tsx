    ...
    <div className="space-y-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upload a photo of your crop to get an AI-powered disease diagnosis and advice.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {isLoading && (
        <Card>
          <CardContent className="p-6 flex flex-col items-center justify-center space-y-4 min-h-[200px]">
            ...
            <p className="text-muted-foreground">Diagnosing crop disease...</p>
          </CardContent>
        </Card>
      )}
      ...
      {result && (
        <Card className="bg-primary/5 border-primary/20">
          <CardHeader>
            ...
            <CardDescription>Here's our analysis of the crop image.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-6">
            <div className="space-y-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Preliminary Advice</CardTitle>
